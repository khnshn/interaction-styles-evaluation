(function() {
    ...
    document.getElementById('q_button').onclick = function() { // look if button is pressed
        ...
        } else if (newInteractionStyle === "V-Button") { // if swiping go to swiping screen
            window.location.href = "Lsc/Arrow_LNSc.html";
        } else if (newInteractionStyle === "LL-Tapping") { // if swiping go to swiping screen
            window.location.href = "Lsc/Tapping_LNSc.html";
        } 
    };
}());