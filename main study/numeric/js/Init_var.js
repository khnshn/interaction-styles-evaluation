...
(function() {
    ...
    function init() {
        ...
        var questionsList = [ // length should be a multiple of interactionsToUse.length
            "1,Which country is famous for the Pyramids?",
            "2,What country did Van Gogh come from?",
            "3,Which country is known for the Eiffel Tower?",
            "4,What is the country where the Great Wall is located?",
            "5,Tokyo is the capital of which country?",
        ];
