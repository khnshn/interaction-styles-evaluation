...
(function() {
    ...
    document.getElementById("small-selector").addEventListener("click", function() {
    	var answerBezel = document.getElementsByClassName("ui-selector-indicator-text")[0].innerText.trim(); // fetch the submitted text answer and remove leading/trailing whitespace
